    ...
    <div className="profile_contents">
        <div className="profile_details_main">
            ...
            <div className="profile_details_card">
                <div className="profile_details_card_heading">User Details</div>
                <div className="profile_details_card_content">
            ...
            <div className="profile_details_card">
                <div className="profile_details_card_heading">Delivery Details</div>
                <div className="profile_details_card_content">
                    <div className="profile_personal_details">
                        <p>Name</p>
                        <input type="text" name="Name" id="" placeholder='Name'/>
            ...
            <div className="profile_details_card">
                <div className="profile_details_card_heading">Payment Details</div>
                <div className="profile_details_card_content">
                    <div className="payment_details_card">
                        <div>
                            <div><img src={VISA} alt="" srcset="" height='20px'/></div>
                            <div>7890 **** **** 4456</div>
                            <div>09/28</div>
                        </div>
                        <div>
