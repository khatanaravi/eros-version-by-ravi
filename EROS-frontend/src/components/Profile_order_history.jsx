...
const Profile_order_history = () => {
    ...
    const orderHistory = [
        {
            order_no: '223344',
            order_item_name: 'Forrero Rocher Cake',
            order_item_category: 'Chocolate Cake',
            order_date: '26 December 2024',
            img_url: 'https://mrbrownbakery.com/image/images/f24lP3RSG3bbKoZWl8q48yw9cFPobfHF9kQeQcR3.jpeg?p=full'
        },
        {
            order_no: '123456',
            order_item_name: 'ABC Cake',
            order_item_category: 'Chocolate Cake',
            order_date: '29 December 2024',
            img_url: 'https://mrbrownbakery.com/image/images/f24lP3RSG3bbKoZWl8q48yw9cFPobfHF9kQeQcR3.jpeg?p=full'
        },
        {
            order_no: '223344',
                ...
                profile_nav.map((item, index)=>{
                    return(
                        ...
                        <div>
                            ...
                            <NavLink to={item.nav_link} className='navlink_active'>{item.icon}<span>{item.nav_link_name}</span></NavLink>
                        </div>
                    ...
                    return(
                        <div className="order_history_card">
                            ...
                            <div className="order_history_card_info">
                                <div className='order_history_title'>{item.order_item_name}</div>
                                <div className='order_history_category_name'>{item.order_item_category}</div>
                                <div className='order_history_order_no'>Order No.: <p>{item.order_no}</p></div>
                                <div className='order_history_order_date'>{item.order_date}</div>
                            </div>
                            </div>
...
export default Profile_order_history